...
def open19():
    class sendDelivery:
        ...
        def widgets(self, window):
            ...
            self.title = Label(window, text="Send Delivery", font = "Verdana 32 bold").pack(pady=5)
            self.Label = Label(window, text="Your Order sequence has been saved locally, OrderID.txt - Format OR priorityOrderID.txt - Format", font = "Verdana 22 bold").pack(pady=5)
